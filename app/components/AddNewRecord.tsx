...
const AddRecord = () => {
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl">
      <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-0.5">
            Easily log your latest transactions with smart AI tracking
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-emerald-50/50 to-green-50/50 dark:from-emerald-900/10 dark:to-green-900/10 rounded-xl border border-emerald-100/50 dark:border-emerald-800/50">
          ...
          <div className="space-y-1.5">
            ...
            {/* Input with AI Suggestion Button */}
            <div className="relative flex items-center">
              <input
                ...
                placeholder="e.g. Grocery shopping, taxi fare, lunch at café"
                required
              />
              <button
                type="button"
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                name="date"
                id="date"
                className="w-full pl-10 pr-3 py-2.5 bg-white/70 dark:bg-gray-800/70 border-2 border-gray-200/80 dark:border-gray-600/80 rounded-xl focus:ring-2 focus:ring-emerald-500/30 focus:bg-white dark:focus:bg-gray-700/90 focus:border-emerald-400 dark:focus:border-emerald-400 text-gray-900 dark:text-gray-100 text-sm shadow-sm hover:shadow-md transition-all duration-200"
                required
      ...
      {alertMessage && (
        <div
          className={`mt-4 p-3 rounded-xl border-l-4 backdrop-blur-sm transition-all duration-300 ${
            alertType === "success"
