...
const AIInsights = () => {
  ...
  if (isLoading) {
    return (
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 transition-shadow hover:shadow-2xl">
        {/* Header */}
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-emerald-500 via-green-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
              Intelligent analysis of your expense patterns
            </p>
          </div>
        ...
        <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700 text-center">
          <div className="flex items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>AI is reviewing your recent transactions...</span>
          </div>
        </div>
      </div>
    );
      ...
      <div className="flex items-center justify-between mb-4 sm:mb-6">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 via-green-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg">
            <BotIcon className="text-white w-4 h-4 sm:w-5 sm:h-5" />
          </div>
          <div>
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-gray-100">
              AI Insights
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-8 h-8 bg-gradient-to-r from-emerald-600 via-green-500 to-teal-500 hover:from-emerald-700 hover:via-green-600 hover:to-teal-600 text-white rounded-xl flex items-center justify-center shadow-lg hover:shadow-xl transition"
          >
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    >
                      <BrainCog className="w-4 h-4 text-emerald-700 dark:text-emerald-300" />
                    </div>
                    <div className="flex-1">
                  ...
                  {insight.action && (
                    <div className="text-left">
                      <button
                        ...
                        className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg font-medium text-xs transition ${getButtonColors(
                          insight.type
                    ...
                    <div className="mt-3 p-3 bg-white/70 dark:bg-gray-700/70 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-600">
                      <div className="flex items-start gap-2">
                        <div className="w-6 h-6 bg-gradient-to-br from-emerald-500 via-green-500 to-teal-500 rounded-lg flex items-center justify-center flex-shrink-0">
                          <BotIcon className="text-white w-3.5 h-3.5" />
                        </div>
                        <div className="flex-1">
                          ...
                          {currentAnswer.isLoading ? (
                            <div className="space-y-1">
                              <div className="animate-pulse bg-gray-200 dark:bg-gray-600 h-2 rounded-lg w-full" />
                              <div className="animate-pulse bg-gray-200 dark:bg-gray-600 h-2 rounded-lg w-3/4" />
                              <div className="animate-pulse bg-gray-200 dark:bg-gray-600 h-2 rounded-lg w-1/2" />
                            </div>
                          ) : (
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
            <div className="w-6 h-6 bg-emerald-50 dark:bg-emerald-900/30 rounded-lg flex items-center justify-center">
              <BrainCog className="w-4 h-4 text-emerald-600 dark:text-emerald-300" />
            </div>
